...
tableSchemaClause
    ...
    ;
engineClause
    : engineExpr (orderByClause | partitionByClause | primaryKeyClause | sampleByClause | ttlClause | settingsClause | commentClause)*
    ;
...
commentClause: COMMENT value=STRING_LITERAL;
...
columnTypeExpr
    : columnType                                                                             # ColumnTypeExprSimple   // UInt64
    | columnType LPAREN columnType columnTypeExpr (COMMA columnType columnTypeExpr)* RPAREN  # ColumnTypeExprNested   // Nested
    | columnType LPAREN enumValue (COMMA enumValue)* RPAREN                                  # ColumnTypeExprEnum     // Enum
    | columnType LPAREN columnTypeExpr (COMMA columnTypeExpr)* RPAREN                        # ColumnTypeExprComplex  // Array, Tuple
    | columnType LPAREN columnExprList? RPAREN                                               # ColumnTypeExprParam    // FixedString(N)
    ;
...
columnExpr
    ...
    | functionIdentifier (LPAREN columnExprList? RPAREN)? LPAREN DISTINCT? columnArgList? RPAREN  # ColumnExprFunction
...
columnLambdaExpr:
    ...
    ARROW columnExpr
    ;
columnIdentifier: (identifier DOT)? nestedIdentifier;
nestedIdentifier: columnNameIdentifier (DOT columnNameIdentifier)?;
...
tableExpr
    ...
    ;
tableFunctionExpr: functionIdentifier LPAREN tableArgList? RPAREN;
...
columnType: IDENTIFIER | INTERVAL_TYPE | keyword;
columnNameIdentifier: IDENTIFIER | keyword;
functionIdentifier:  IDENTIFIER | INTERVAL_TYPE | keyword;
