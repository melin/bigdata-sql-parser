...
public interface ArithmeticVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitWindowRef(ArithmeticParser.WindowRefContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitWindowDef(ArithmeticParser.WindowDefContext ctx);
	/**
	 * Visit a parse tree produced by {@link ArithmeticParser#sortItem}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSortItem(ArithmeticParser.SortItemContext ctx);
	/**
