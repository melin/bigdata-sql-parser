...
public class ArithmeticParser extends Parser {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"primaryExpression", "windowSpec", "sortItem", "comparisonOperator", 
			"whenClause", "functionName", "identifier", "constant", "setQuantifier", 
			"number", "booleanValue"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"WHEN", "THEN", "ELSE", "END", "DISTINCT", "ALL", "OVER", "CLUSTER", 
			"BY", "DISTRIBUTE", "PARTITION", "ORDER", "SORT", "ASC", "DESC", "NULLS", 
			"LAST", "FIRST", "EQ", "NSEQ", "NEQ", "NEQJ", "LT", "LTE", "GT", "GTE", 
			"LBRACKET", "RBRACKET", "PLUS", "MINUS", "ASTERISK", "SLASH", "PERCENT", 
			"DIV", "TILDE", "AMPERSAND", "PIPE", "CONCAT_PIPE", "HAT", "BIGINT_LITERAL", 
			"SMALLINT_LITERAL", "TINYINT_LITERAL", "INTEGER_VALUE", "IDENTIFIER", 
			"DOUBLE_LITERAL", "BIGDECIMAL_LITERAL", "SIMPLE_COMMENT", "BRACKETED_EMPTY_COMMENT", 
			"BRACKETED_COMMENT", "WS", "UNRECOGNIZED", "NOT", "AND", "OR", "BETWEEN", 
			"IN", "RLIKE", "LIKE", "ESCAPE", "IS", "UNKNOWN"
		};
	}
