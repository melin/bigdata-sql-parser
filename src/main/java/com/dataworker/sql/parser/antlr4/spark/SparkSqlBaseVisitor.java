...
public interface SparkSqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitHiveReplaceColumns(SparkSqlBaseParser.HiveReplaceColumnsContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitShowTableExtended(SparkSqlBaseParser.ShowTableExtendedContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitRefreshFunction(SparkSqlBaseParser.RefreshFunctionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitSetTimeZone(SparkSqlBaseParser.SetTimeZoneContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitSetQuotedConfiguration(SparkSqlBaseParser.SetQuotedConfigurationContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitResetQuotedConfiguration(SparkSqlBaseParser.ResetQuotedConfigurationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SparkSqlBaseParser#configKey}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConfigKey(SparkSqlBaseParser.ConfigKeyContext ctx);
	/**
	 * Visit a parse tree produced by {@link SparkSqlBaseParser#configValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConfigValue(SparkSqlBaseParser.ConfigValueContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SparkSqlBaseParser#partitionFieldList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPartitionFieldList(SparkSqlBaseParser.PartitionFieldListContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPartitionTransform(SparkSqlBaseParser.PartitionTransformContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPartitionColumn(SparkSqlBaseParser.PartitionColumnContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFloatLiteral(SparkSqlBaseParser.FloatLiteralContext ctx);
	/**
