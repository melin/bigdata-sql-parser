...
public interface ArithmeticListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link ArithmeticParser#windowSpec}.
	 * @param ctx the parse tree
	 */
	void enterWindowRef(ArithmeticParser.WindowRefContext ctx);
	/**
	 * Exit a parse tree produced by the {@code windowRef}
	 * labeled alternative in {@link ArithmeticParser#windowSpec}.
	 * @param ctx the parse tree
	 */
	void exitWindowRef(ArithmeticParser.WindowRefContext ctx);
	/**
	 * Enter a parse tree produced by the {@code windowDef}
	 * labeled alternative in {@link ArithmeticParser#windowSpec}.
	 * @param ctx the parse tree
	 */
	void enterWindowDef(ArithmeticParser.WindowDefContext ctx);
	/**
	 * Exit a parse tree produced by the {@code windowDef}
	 * labeled alternative in {@link ArithmeticParser#windowSpec}.
	 * @param ctx the parse tree
	 */
	void exitWindowDef(ArithmeticParser.WindowDefContext ctx);
	/**
	 * Enter a parse tree produced by {@link ArithmeticParser#sortItem}.
	 * @param ctx the parse tree
	 */
	void enterSortItem(ArithmeticParser.SortItemContext ctx);
	/**
	 * Exit a parse tree produced by {@link ArithmeticParser#sortItem}.
	 * @param ctx the parse tree
	 */
	void exitSortItem(ArithmeticParser.SortItemContext ctx);
	/**
